...
/**
 * Created by Hbx on 2018/9/5.
 */
@Component
@Lazy(value = false)
public class QuartzUpdateGame implements Job {
    private static final Logger logger = Logger.getLogger(QuartzUpdateGame.class);
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        QuartzInfo qi = quartzInfoService.findByCode("doUpdateGame");
        ...
        try {
            logger.info("进入爬取赛事进度定期任务。。。。。");
            crawlService.updateMatch();
